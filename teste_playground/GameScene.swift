...
public class GameScene: SKScene {
    ...
    public override func didMove(to view: SKView) {
        ...
        plus_node.position = CGPoint(x: width / 1.07, y: height / 1.09)
    ...
    private func button_plus_action() {
        ...
        add_gate_node.position = CGPoint(x: width / 1.07, y: height / 1.6)
        ...
        for gate in gates {
            ...
            add_gate_node.position = CGPoint(x: width / 1.07, y: height / 1.2 + gambi)
            gambi -= add_gate_node.size.height + 15
    ...
    private func add(_ gate: String) {
        ...
        node.position = CGPoint(x: 150, y: 150)
        self.addChild(node)
    }
}
